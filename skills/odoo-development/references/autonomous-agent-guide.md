...
│                                                                     │
│ skills/odoo-development/references/odoo-module-generator-{version}.md                       │
│ skills/odoo-development/references/odoo-model-patterns-{version}.md                         │
│ skills/odoo-development/references/odoo-security-guide-{version}.md                         │
│                                                                     │
│ If UI includes OWL:                                                 │
│ skills/odoo-development/references/odoo-owl-components-{version}.md                         │
└─────────────────────────────────────────────────────────────────────┘
                              │
                              ▼
┌─────────────────────────────────────────────────────────────────────┐
