...
<odoo>
    ...
    <!-- Multi-Company Record Rule (v18 pattern: keep documented company_ids) -->
...
6. **Use** `company_ids` in multi-company rules and `allowed_company_ids` only in Python/context when needed
