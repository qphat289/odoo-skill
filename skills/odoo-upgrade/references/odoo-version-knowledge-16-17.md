...
| Assets | legacy bundle assumptions break more often | Medium - Re-check manifest asset targets |
...
## Asset bundle migration note

When migrating frontend code to v17:

- re-check asset bundle names instead of copying a v14-v16 manifest unchanged
- prefer bundling XML templates with the JS bundle that consumes them
- verify report styling under `web.report_assets_common` when report SCSS is involved
