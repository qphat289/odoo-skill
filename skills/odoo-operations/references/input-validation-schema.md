...
VERSION_FEATURES = {
    ...
    "19.0": {
        ...
        "command_class": True,
        "create_multi": True,
        "check_company_auto": True,  # Strong default
        "sql_builder": True,  # Preferred
        "type_hints": True,  # Preferred
    },
}
...
def check_version_compatibility(data: dict) -> list[str]:
    ...
    if data['ui_stack'] in ['owl', 'hybrid']:
        ...
        elif features['owl'] == 'verify-upstream':
            warnings.append(f"Verify frontend patterns against upstream for v{version}")
